...
class InMemoryMetricsStoreTests(TestCase):
    ...
    def test_filter_percentiles_by_sample_size(self): 
        test_percentiles = [0, 0.0001, 0.001, 0.01, 0.1, 4, 10, 10.01, 45, 50, 90, 98.9, 98.91, 98.999, 99, 99.9, 99.99, 99.999, 99.9999, 100]
        sample_size_to_result_map = { 
            ...
            1000: [0, 0.1, 4, 10, 45, 50, 90, 98.9, 99, 99.9, 100], 
            ...
            100001: [0, 0.0001, 0.001, 0.01, 0.1, 4, 10, 10.01, 45, 50, 90, 98.9, 98.91, 98.999, 99, 99.9, 99.99, 99.999, 99.9999, 100]
