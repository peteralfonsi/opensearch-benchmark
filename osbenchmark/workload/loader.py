...
class QueryRandomizerWorkloadProcessor(WorkloadProcessor):
    ...
    def __init__(self, cfg):
        ...
        self.zipf_alpha = float(cfg.opts("workload", "randomization.alpha", mandatory=False, default_value=self.DEFAULT_RF))
    ...
    def zipf_cdf_inverse(self, u, H_list):
        ...
        while candidate_return < n:
            ...
            candidate_return += 1
        console.info("ZIPF alpha = {}, returning {}".format(self.zipf_alpha, candidate_return), end="", flush=True, logger=self.logger)
        return n
